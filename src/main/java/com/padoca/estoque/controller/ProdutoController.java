...
public class ProdutoController {
    ...
    public String novoRegistro(HttpSession sessao, Model model) {
        ...
        // Vai abrir o mesmo formulário para edição /inclusão, mas sem os dados
        // preenchidos, pois é um novo produto
    ...
    public String salvarProduto(
            HttpSession sessao,
            @Valid @ModelAttribute Produto produto, BindingResult errosAcumulados, // Classe responsável por encontrar
                                                                                   // todos os erros de validação do
                                                                                   // produto
            Model model) {
